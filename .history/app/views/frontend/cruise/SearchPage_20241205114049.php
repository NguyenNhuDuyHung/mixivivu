<div class="SearchPageDetail-search-page flex flex-col gap-80 container">
    ...
    <div class="fresnel-container fresnel-lessThan-md">
        <div class="Card-card SearchPageDetail-collapse">
            <div class="SearchPageDetail-custom-header">
                <div class="SearchPageDetail-collapse-header">
                    <div class="subheading sm flex-grow" style="color: var(--gray-800);">Tìm kiếm</div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M6 12H18M12 6V18" stroke="#77dada" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                </div>
            </div>
            <div class="Collapse-collapse-content Collapse-collapse" style="height: 0;">
                <div>
    ...
    <div>
        <div class="SearchPageDetail-header">
            <div class="SearchPageDetail-title">
        ...
        <div class="fresnel-container fresnel-lessThan-md fresnel-greaterThan-sm">
                    ...
                    <div class="SearchPageDetail-ship-list flex flex-col gap-32">
                        ...
                        <?php foreach ($ships as $ship):
                            ...
                            <a href="<?= _WEB_ROOT ?>/du-thuyen/<?= $ship['slug'] ?>">
                                <div class="Card-card ProductCard-grid">
...
<script type="module">
    ...
    SearchPageDetailFilterBtn.addEventListener("click", () => {
        ...
        if (SearchPageDetailSideBarMobile) {
            ...
            let html = `
            <div class="SearchPageDetail-side-bar-2 flex flex-col SearchPageDetail-side-bar-mobile">
                <div class="SearchPageDetail-side-bar-header">
                    <div class="subheading md flex-grow">Lọc kết quả</div>
                    <div class="flex gap-10 align-center">
                        <button type="button" class="btn SearchPageDetail-remove-chechbox-mb-btn btn-sm btn-link-color">
                            <div class="label sm">Đặt lại</div>
                        </button>
                        <button type="button" class="btn SearchPageDetail-apply-mb-btn btn-sm btn-link-color">
                            <div class="label sm">Áp dụng</div>
    ...
    listCheckbox.forEach((checkbox) => {
        checkbox.addEventListener("change", () => {
            ...
            fetch(`<?= _WEB_ROOT ?>/api/cruise/sortWithCheckbox/${sortOrderString}`, {
                    method: "GET",
                })
                .then((res) => res.text())
                .then((data) => {
