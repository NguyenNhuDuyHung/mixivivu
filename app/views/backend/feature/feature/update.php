<div class="action-page">
    <form method="post" action="" id="FeatureUpdateForm">
        <div class="modal">
                ...
                <div class="form-group">
                    <div class="">
                        <label for="icon" class="input-group">
                            <textarea id="icon" class="p-md" placeholder="Nhập icon.  Lưu ý: Nhập thẻ svg" name="icon" autocomplete="off"><?php echo $this->oldInfo('icon', $data) ?? $data['feature']['icon']; ?></textarea>
