<div class="action-page">
    <form method="post" action="" id="FeatureUpdateForm" enctype="multipart/form-data">
        <div class="modal">
                    ...
                    <div class="">
                        <label for="text" class="input-group">
                            <input id="text" class="p-md" placeholder="Nhập tên đặc trưng" name="text"
                                value="<?php echo $this->oldInfo('text', $data) ?? $data['feature']['text']; ?>" autocomplete="off">
                    ...
                    <div class="select-input">
                        <label for="type" class="input-group">
                            <input id="type" class="p-md" placeholder="Chọn loại đặc trưng" name="type"
                                value="<?php echo $this->oldInfo('type', $data) ?? $data['feature']['type'] == 1 ? 'room' : 'ship'; ?>" autocomplete="off">
                        ...
                        <label for="upload-icon" class="flex align-center">
                            <div class="flex align-center gap-16">
                                ...
                                <div class="preview-icon">
                                    <?php
                                    if (!empty($data['feature']['icon'])) {
                                        echo '<img class="preview-upload-image" src="'  . $data['feature']['icon'] . '" alt="">';
                                    } else {
                                        echo '<div class="temp-icon"><svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" fill="none">
