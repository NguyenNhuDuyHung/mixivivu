<div class="action-page">
    <form method="post" action="" id="FeatureCatalogueUpdateForm">
        <div class="modal">
                ...
                <div class="form-group">
                    <div class="">
                        <label for="name" class="input-group">
                            <input id="name" class="p-md" placeholder="Nhập tên đặc trưng" name="name"
                                value="<?php echo $this->oldInfo('name', $data) ?? $data['feature_type']['name']; ?>" autocomplete="off">
