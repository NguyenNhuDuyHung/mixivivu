<div class="action-page">
    <form method="post" action="" id="ShortDescUpdateForm">
        <div class="modal">
                    ...
                    <div class="">
                        <label for="description" class="input-group">
                            <input id="description" class="p-md" placeholder="Nhập mô tả ngắn" name="description"
                                value="<?php echo $this->oldInfo('description', $data) ?? $data['short_desc']['description']; ?>" autocomplete="off">
                    ...
                    <div class="select-input">
                        <label for="product_id" class="input-group">
                            <input id="product_id" class="p-md" placeholder="Chọn sản phẩm" name="product_id"
                                value="<?php echo $this->oldInfo('product_id', $data) ?? $data['short_desc']['product_id']; ?>" autocomplete="off">
