<div class="action-page">
    <form method="post" action="" id="CruiseCatalogueUpdateForm" enctype="multipart/form-data">
        <div class="modal">
                    ...
                    <div class="">
                        <label for="name" class="input-group">
                            <input id="name" class="p-md" placeholder="Nhập tiêu đề" name="name"
                                value="<?php echo $this->oldInfo('name', $data) ?? $data['ship_catalogue']['name'] ?>" autocomplete="off">
