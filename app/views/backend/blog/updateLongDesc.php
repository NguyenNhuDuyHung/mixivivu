<div class="action-page">
    <form method="post" action="" id="BlogCreateLongDescForm" enctype="multipart/form-data">
        <div class="modal long-desc">
            ...
            <div class="warning-title">
                <div style="color: red;" class="subheading lg">Lưu ý: Thứ tự tạo mô tả sẽ tương ứng với thứ tự khi render ra chi tiết!</div>
            </div>

            <div class="group-input">
                <div class="form-group">
                    <div class="select-input">
                        <label for="blog_id" class="input-group">
                            <input id="blog_id" class="p-md" placeholder="Chọn blog" name="blog_id"
                                value="<?php echo $this->oldInfo('blog_id', $data) ?>" autocomplete="off">
                            <label for="blog_id" class="sm input-required">
                                BlogID
                            </label>
                        </label>
                    </div>
            ...
            <div class="flex align-center gap-16 create-desc">
                <div class="create-list">
                    <button type="button" class="btn btn-normal btn-outline">
                        <div class="label md">Tạo list</div>
            ...
            foreach ($data['descriptions'] as $key => $description) {
                ...
                if ($description['type'] == '4') {
                    echo '<div class="flex align-center gap-8">
                                ...
                                <div class="">
                                    <label for="list ' . $uniqueId . '" class="input-group">
                                         <input id="list ' . $uniqueId . '" class="p-md" placeholder="Nhập text" name="text[]" data-type="4"
                                         value="' . $description['text'] . '"
                                            autocomplete="off">
                                            <input type="hidden" name="type[]" value="4">
                                        <label for="list ' . $uniqueId . '" class="sm input-required">
                                            List
                                        </label>
                                    </label>
                                </div>
