<div class="action-page">
    <form method="post" action="" id="BlogDeleteForm">
        <div class="modal">
            ...
            <div class="group-input">
                ...
                <div class="form-group">
                    <div class="">
                        <label for="blog" class="input-group">
                            <input id="blog" class="p-md" name="blog"
                                value="<?= $data['blog']['title']; ?>" autocomplete="off" disabled>
                            <label for="blog" class="sm input-required">
                                Blog
                            </label>
                        </label>
                    </div>
