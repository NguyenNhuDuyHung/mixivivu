...
<?php
$imagesJson = json_encode($hotelImages);
?>

<script>
    const hotelImages = <?php echo $imagesJson; ?>;
    ...
    function loadImages() {
        ...
        const endIndex = Math.min(currentIndex + itemsPerPage, hotelImages.length);
        ...
        for (let i = currentIndex; i < endIndex; i++) {
            ...
            item.innerHTML = `<div style="width: 100%; height: 100%; position: relative; overflow: hidden;">
                                <img alt="du-thuyen-banner" src="${hotelImages[i]}" width="100%" height="100%" loading="lazy" style="object-fit: cover;">
                            </div>`;
