...
createListBtn.addEventListener("click", () => {
  ...
  html.innerHTML = `
                <div class="form-group" style="flex: 1">
                    <div class="">
                        <label for="list${countList}" class="input-group">
                            <input id="list${countList}" class="p-md" placeholder="Nhập text" name="text[]" data-type="4"
                                autocomplete="off">
                                <input type="hidden" name="type[]" value="4">
                            <label for="list${countList}" class="sm input-required">
                                List
                            </label>
                        </label>
                    </div>
  ...
  listDesc = longDesc.querySelectorAll("input[name='text[]']");
